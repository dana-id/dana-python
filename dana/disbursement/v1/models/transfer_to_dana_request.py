...
class TransferToDanaRequest(BaseModel, BaseSdkModel):
    """
    ...
    category_id: Optional[Union[Annotated[float, Field(le=9999999999, strict=True)], Annotated[int, Field(le=2147483647, strict=True)]]] = Field(default=None, description="Category identifier")
    notes: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Transaction notes")
    additional_info: TransferToDanaRequestAdditionalInfo = Field()
    __properties: ClassVar[List[str]] = ["partnerReferenceNo", "customerNumber", "amount", "feeAmount", "transactionDate", "sessionId", "categoryId", "notes", "additionalInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "additionalInfo": TransferToDanaRequestAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None
        })
        return _obj
