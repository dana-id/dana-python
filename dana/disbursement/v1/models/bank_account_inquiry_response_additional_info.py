...
class BankAccountInquiryResponseAdditionalInfo(BaseModel, BaseSdkModel):
    """
    Additional information
    """ # noqa: E501
    fee_amount: Money = Field(description="Additional information of fee amount. Contains two sub-fields:<br> 1. Value: Amount, including the cents<br> 2. Currency: Currency code based on ISO ")
    __properties: ClassVar[List[str]] = ["feeAmount"]
