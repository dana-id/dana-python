...
class BankAccountInquiryRequest(BaseModel, BaseSdkModel):
    """
    ...
    additional_info: BankAccountInquiryRequestAdditionalInfo = Field()
    __properties: ClassVar[List[str]] = ["partnerReferenceNo", "customerNumber", "beneficiaryAccountNumber", "amount", "additionalInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalInfo": BankAccountInquiryRequestAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None
        })
        return _obj
