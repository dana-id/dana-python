...
class DanaAccountInquiryRequest(BaseModel, BaseSdkModel):
    """
    ...
    additional_info: DanaAccountInquiryRequestAdditionalInfo = Field()
    __properties: ClassVar[List[str]] = ["partnerReferenceNo", "customerNumber", "amount", "transactionDate", "additionalInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalInfo": DanaAccountInquiryRequestAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None
        })
        return _obj
