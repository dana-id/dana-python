...
class ApplyOTTResponseUserResourcesInner(BaseModel, BaseSdkModel):
    """
    ...
    value: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Value of OTT")
