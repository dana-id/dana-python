...
class QueryUserProfileResponseResponse(BaseModel, BaseSdkModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "body": QueryUserProfileResponseResponseBody.from_dict(obj["body"]) if obj.get("body") is not None else None
        })
        return _obj
