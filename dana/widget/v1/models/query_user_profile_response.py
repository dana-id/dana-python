...
class QueryUserProfileResponse(BaseModel, BaseSdkModel):
    """
    QueryUserProfileResponse
    """ # noqa: E501
    response: QueryUserProfileResponseResponse
    signature: Optional[StrictStr] = Field(default=None, description="Signature string")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": QueryUserProfileResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
