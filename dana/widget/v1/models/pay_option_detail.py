...
class PayOptionDetail(BaseModel, BaseSdkModel):
    ...
    PayOptionDetail
    """ # noqa: E501
    pay_method: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Payment Method, e.g. CREDIT_CARD")
    pay_option: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Payment option which shows the provider of this payment e.g. CREDIT_CARD_VISA")
    trans_amount: Optional[Money] = Field(default=None, description="Trans amount. Contains value and currency")
    fee_amount: Optional[Money] = Field(default=None, description="Fee amount. Contains value and currency")
    card_token: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Card token used for this payment")
    merchant_token: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Merchant token used for this payment")
    additional_info: Optional[PayOptionDetailAdditionalInfo] = Field(default=None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalInfo": PayOptionDetailAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None
        })
        return _obj
