...
class ApplyOTTResponse(BaseModel, BaseSdkModel):
    """
    ApplyOTTResponse
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in user_resources (list)
        _items = []
        if self.user_resources:
            for _item_user_resources in self.user_resources:
                if _item_user_resources:
                    _items.append(_item_user_resources.to_dict())
            _dict['userResources'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userResources": [ApplyOTTResponseUserResourcesInner.from_dict(_item) for _item in obj["userResources"]] if obj.get("userResources") is not None else None,
