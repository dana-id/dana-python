...
class AccountUnbindingResponse(BaseModel, BaseSdkModel):
    """
    ...
    unlink_result: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Result of unlinking process")
    additional_info: Optional[Dict[str, Any]] = Field(default=None, description="Additional information")
    __properties: ClassVar[List[str]] = ["responseCode", "responseMessage", "referenceNo", "partnerReferenceNo", "merchantId", "subMerchantId", "linkId", "unlinkResult", "additionalInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unlinkResult": obj.get("unlinkResult"),
