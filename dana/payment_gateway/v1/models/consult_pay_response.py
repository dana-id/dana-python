...
class ConsultPayResponse(BaseModel, BaseSdkModel):
    ...
    ConsultPayResponse
    """ # noqa: E501
    response_code: Optional[Annotated[str, Field(strict=True, max_length=7)]] = Field(default=None, description="Response code. Refer to https://dashboard.dana.id/api-docs/read/237#paymentgatewayprod-ConsultPay-ResponseCodeandMessage")
    response_message: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Response message. Refer to https://dashboard.dana.id/api-docs/read/237#paymentgatewayprod-ConsultPay-ResponseCodeandMessage")
    payment_infos: Optional[List[ConsultPayPaymentInfo]] = Field(default=None, description="Define list of payment information that includes payment method and payment option for transaction")
