...
class CreateOrderByApiAdditionalInfo(BaseModel, BaseSdkModel):
    """
    ...
    order: Optional[OrderApiObject] = Field(default=None, description="Additional information of order")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": OrderApiObject.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
