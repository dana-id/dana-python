...
class MerchantManagementApi:
    ...
    def create_division(
        ...
        :param create_division_request: (required)
        :type create_division_request: CreateDivisionRequest
        ...
        _param = self._create_division_serialize(
    ...
    @validate_call
    def create_division_with_http_info(
        self,
        create_division_request: CreateDivisionRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateDivisionResponse]:
        """Create Division
    ...
    @validate_call
    def create_division_without_preload_content(
        self,
        create_division_request: CreateDivisionRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_division_serialize(
        self,
        create_division_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_division_request is not None:
            _body_params = create_division_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            function_name="dana.merchant.division.createDivision",
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": create_division_request.to_dict()
            }
        }
    ...
    def create_shop(
        ...
        :param create_shop_request: (required)
        :type create_shop_request: CreateShopRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_shop_serialize(
    ...
    @validate_call
    def create_shop_with_http_info(
        self,
        create_shop_request: CreateShopRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateShopResponse]:
        """Member – Create Shop
    ...
    @validate_call
    def create_shop_without_preload_content(
        self,
        create_shop_request: CreateShopRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_shop_serialize(
        self,
        create_shop_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_shop_request is not None:
            _body_params = create_shop_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.shop.createShop",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": create_shop_request.to_dict()
            }
        }
    ...
    def query_division(
        ...
        :param query_division_request: (required)
        :type query_division_request: QueryDivisionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._query_division_serialize(
            query_division_request=query_division_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def query_division_with_http_info(
        self,
        query_division_request: QueryDivisionRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryDivisionResponse]:
        """Query Division
    ...
    @validate_call
    def query_division_without_preload_content(
        self,
        query_division_request: QueryDivisionRequest,
        _request_timeout: Union[
            None,
    ...
    def _query_division_serialize(
        self,
        query_division_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if query_division_request is not None:
            _body_params = query_division_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.division.queryDivision",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": query_division_request.to_dict()
            }
        }
    ...
    def query_merchant_resource(
        ...
        :param query_merchant_resource_request: (required)
        :type query_merchant_resource_request: QueryMerchantResourceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._query_merchant_resource_serialize(
            query_merchant_resource_request=query_merchant_resource_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QueryMerchantResourceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def query_merchant_resource_with_http_info(
        self,
        query_merchant_resource_request: QueryMerchantResourceRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryMerchantResourceResponse]:
        """Member – Merchant Open API Check Disbursement Account
    ...
    @validate_call
    def query_merchant_resource_without_preload_content(
        self,
        query_merchant_resource_request: QueryMerchantResourceRequest,
        _request_timeout: Union[
            None,
    ...
    def _query_merchant_resource_serialize(
        self,
        query_merchant_resource_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if query_merchant_resource_request is not None:
            _body_params = query_merchant_resource_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.queryMerchantResource",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": query_merchant_resource_request.to_dict()
            }
        }
    ...
    def query_shop(
        ...
        :param query_shop_request: (required)
        :type query_shop_request: QueryShopRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._query_shop_serialize(
            query_shop_request=query_shop_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def query_shop_without_preload_content(
        self,
        query_shop_request: QueryShopRequest,
        _request_timeout: Union[
            None,
    ...
    def _query_shop_serialize(
        self,
        query_shop_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if query_shop_request is not None:
            _body_params = query_shop_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.shop.queryShop",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": query_shop_request.to_dict()
            }
        }
    ...
    def update_division(
        ...
        :param update_division_request: (required)
        :type update_division_request: UpdateDivisionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_division_serialize(
    ...
    @validate_call
    def update_division_with_http_info(
        self,
        update_division_request: UpdateDivisionRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateDivisionResponse]:
        """Update Division
    ...
    @validate_call
    def update_division_without_preload_content(
        self,
        update_division_request: UpdateDivisionRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_division_serialize(
        self,
        update_division_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_division_request is not None:
            _body_params = update_division_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.division.updateDivision",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": update_division_request.to_dict()
            }
        }
    ...
    def update_shop(
        ...
        :param update_shop_request: (required)
        :type update_shop_request: UpdateShopRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def update_shop_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateShopResponse]:
        """Update Shop
    ...
    def _update_shop_serialize(
        self,
        update_shop_request: Type[BaseSdkModel],
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_shop_request is not None:
            _body_params = update_shop_request
        ...
        _generated_auth = OpenApiHeader.get_open_api_generated_headers(
            ...
            body='{}',  # Empty body for head generation
            function_name="dana.merchant.shop.updateShop",
            client_id=self.api_client.configuration.get_api_key_with_prefix('X_PARTNER_ID'),
            client_secret=self.api_client.configuration.get_api_key_with_prefix('CLIENT_SECRET')
        )
        ...
        request_body = {
            "request": {
                "head": head_params,
                "body": update_shop_request.to_dict()
            }
        }
