...
class ResultInfo(BaseModel, BaseSdkModel):
    """
    ResultInfo
    """ # noqa: E501
    result_status: StrictStr = Field(description="Result status (S=Success, F=Failure, U=Unknown)")
    result_code_id: StrictStr = Field(description="Result code identifier")
    result_code: StrictStr = Field(description="Result code")
    result_msg: StrictStr = Field(description="Result message")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "ResultInfo".endswith("Response") and "response" in obj and "body" in obj["response"]:
