...
class MerchantContactEmail(BaseModel, BaseSdkModel):
    """
    Contact email (`contactEmail` in merchantInformation)
    """ # noqa: E501
    email: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Merchant contact email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "MerchantContactEmail".endswith("Response") and "response" in obj and "body" in obj["response"]:
