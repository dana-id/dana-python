...
class UpdateDivisionResponseResponseBody(BaseModel, BaseSdkModel):
    """
    UpdateDivisionResponseResponseBody
    """ # noqa: E501
    result_info: ResultInfo = Field()
    __properties: ClassVar[List[str]] = ["resultInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "UpdateDivisionResponseResponseBody".endswith("Response") and "response" in obj and "body" in obj["response"]:
