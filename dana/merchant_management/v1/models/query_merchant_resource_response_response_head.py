...
class QueryMerchantResourceResponseResponseHead(BaseModel, BaseSdkModel):
    """
    ...
    resp_time: Optional[StrictStr] = Field(default=None, description="DateTime with timezone, which follows the ISO-8601 standard. Refer to RFC 3339 Section 5.6")
    req_msg_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Request message ID")
    __properties: ClassVar[List[str]] = ["version", "function", "clientId", "respTime", "reqMsgId"]
    ...
    def function_validate_enum(cls, value):
        ...
        if value not in set(['dana.merchant.queryMerchantResource']):
            raise ValueError("must be one of enum values ('dana.merchant.queryMerchantResource')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryMerchantResourceResponseResponseHead".endswith("Response") and "response" in obj and "body" in obj["response"]:
