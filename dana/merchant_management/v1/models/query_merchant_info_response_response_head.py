...
class QueryMerchantInfoResponseResponseHead(BaseModel, BaseSdkModel):
    """
    ...
    client_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Client ID provided by DANA, used to identify partner and application system")
    resp_time: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="DateTime with timezone (ISO-8601), GMT+7 (Jakarta time)")
    req_msg_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Request message ID")
    client_secret: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="As a secret key of client. Assigned client secret during registration")
    reserve: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["version", "function", "clientId", "respTime", "reqMsgId", "clientSecret", "reserve"]
    ...
    def function_validate_enum(cls, value):
        ...
        if value not in set(['dana.ap.bizprod.biz.service.openapi.merchant.queryMerchantInfo']):
            raise ValueError("must be one of enum values ('dana.ap.bizprod.biz.service.openapi.merchant.queryMerchantInfo')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryMerchantInfoResponseResponseHead".endswith("Response") and "response" in obj and "body" in obj["response"]:
