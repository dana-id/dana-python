...
class MerchantCorporateCertificate(BaseModel, BaseSdkModel):
    """
    Corporate certificate (`corporateCertificate` in merchantInformation)
    """ # noqa: E501
    certificate_no: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Certificate number")
    certificate_type: Optional[Annotated[str, Field(strict=True, max_length=16)]] = Field(default=None, description="Type of certificate")
    __properties: ClassVar[List[str]] = ["certificateNo", "certificateType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "MerchantCorporateCertificate".endswith("Response") and "response" in obj and "body" in obj["response"]:
