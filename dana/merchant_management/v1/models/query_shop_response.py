...
class QueryShopResponse(BaseModel, BaseSdkModel):
    """
    QueryShopResponse
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryShopResponse".endswith("Response") and "response" in obj and "body" in obj["response"]:
            # For OPEN_API nested format, pass the nested response structure directly
            _obj = cls.model_validate({
                "response": QueryShopResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
