...
class PicInfo(BaseModel, BaseSdkModel):
    """
    PicInfo
    """ # noqa: E501
    pic_name: Optional[StrictStr] = Field(default=None, description="PIC name")
    pic_position: Optional[StrictStr] = Field(default=None, description="PIC position")
    __properties: ClassVar[List[str]] = ["picName", "picPosition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "PicInfo".endswith("Response") and "response" in obj and "body" in obj["response"]:
            # For OPEN_API nested format, pass the nested response structure directly
            _obj = cls.model_validate({
                "picName": obj.get("picName"),
                "picPosition": obj.get("picPosition")
            })
        else:
