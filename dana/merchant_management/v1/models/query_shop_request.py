...
class QueryShopRequest(BaseModel, BaseSdkModel):
    """
    QueryShopRequest
    """ # noqa: E501
    merchant_id: Optional[Annotated[str, Field(strict=True, max_length=21)]] = Field(default=None, description="Merchant identifier. Required when shopIdType is EXTERNAL_ID")
    ...
    __properties: ClassVar[List[str]] = ["merchantId", "shopId", "shopIdType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryShopRequest".endswith("Response") and "response" in obj and "body" in obj["response"]:
