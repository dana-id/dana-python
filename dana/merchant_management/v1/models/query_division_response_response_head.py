...
class QueryDivisionResponseResponseHead(BaseModel, BaseSdkModel):
    """
    ...
    def function_validate_enum(cls, value):
        ...
        if value not in set(['dana.merchant.division.queryDivision']):
            raise ValueError("must be one of enum values ('dana.merchant.division.queryDivision')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryDivisionResponseResponseHead".endswith("Response") and "response" in obj and "body" in obj["response"]:
