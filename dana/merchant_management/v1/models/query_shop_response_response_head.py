...
class QueryShopResponseResponseHead(BaseModel, BaseSdkModel):
    """
    ...
    def function_validate_enum(cls, value):
        ...
        if value not in set(['dana.merchant.shop.queryShop']):
            raise ValueError("must be one of enum values ('dana.merchant.shop.queryShop')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryShopResponseResponseHead".endswith("Response") and "response" in obj and "body" in obj["response"]:
