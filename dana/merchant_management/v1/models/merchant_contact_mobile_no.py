...
class MerchantContactMobileNo(BaseModel, BaseSdkModel):
    """
    Contact mobile number (`contactMobileNo` in merchantInformation)
    """ # noqa: E501
    mobile_no: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Mobile phone number")
    is_verified: Optional[Annotated[str, Field(strict=True, max_length=5)]] = Field(default=None, description="Whether the mobile number is verified (API may return true/false or TRUE/FALSE)")
    __properties: ClassVar[List[str]] = ["mobileNo", "isVerified"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "MerchantContactMobileNo".endswith("Response") and "response" in obj and "body" in obj["response"]:
