...
class MobileNoInfo(BaseModel, BaseSdkModel):
    """
    MobileNoInfo
    """ # noqa: E501
    mobile_no: Optional[StrictStr] = Field(default=None, description="Mobile number. Accepted formats: 0xxxxxxxx, 62xxxxxxx, 62-xxxxxxx, +62xxxxxx")
    mobile_id: Optional[StrictStr] = Field(default=None, description="Mobile ID")
    verified: Optional[StrictStr] = Field(default=None, description="Verification status")
    __properties: ClassVar[List[str]] = ["mobileNo", "mobileId", "verified"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "MobileNoInfo".endswith("Response") and "response" in obj and "body" in obj["response"]:
