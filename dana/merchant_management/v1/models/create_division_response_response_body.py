...
class CreateDivisionResponseResponseBody(BaseModel, BaseSdkModel):
    """
    CreateDivisionResponseResponseBody
    """ # noqa: E501
    result_info: ResultInfo = Field()
    division_id: Optional[Annotated[str, Field(strict=True, max_length=21)]] = Field(default=None, description="Division identifier. Present when successfully processed")
    __properties: ClassVar[List[str]] = ["resultInfo", "divisionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "CreateDivisionResponseResponseBody".endswith("Response") and "response" in obj and "body" in obj["response"]:
