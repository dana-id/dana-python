...
class CreateShopResponseResponseBody(BaseModel, BaseSdkModel):
    """
    CreateShopResponseResponseBody
    """ # noqa: E501
    result_info: ResultInfo = Field()
    shop_id: Optional[StrictStr] = Field(default=None, description="The shop ID that was created. Present when resultCodeId is 00000000")
    __properties: ClassVar[List[str]] = ["resultInfo", "shopId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "CreateShopResponseResponseBody".endswith("Response") and "response" in obj and "body" in obj["response"]:
