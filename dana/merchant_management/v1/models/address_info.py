...
class AddressInfo(BaseModel, BaseSdkModel):
    """
    AddressInfo
    """ # noqa: E501
    ...
    area: Optional[StrictStr] = Field(default=None, description="Area")
    address1: Optional[StrictStr] = Field(default=None, description="Primary address line")
    ...
    sub_district: Optional[StrictStr] = Field(default=None, description="Sub district")
    __properties: ClassVar[List[str]] = ["country", "province", "city", "area", "address1", "address2", "postcode", "subDistrict"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "AddressInfo".endswith("Response") and "response" in obj and "body" in obj["response"]:
