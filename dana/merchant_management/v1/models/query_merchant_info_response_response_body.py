...
class QueryMerchantInfoResponseResponseBody(BaseModel, BaseSdkModel):
    """
    Response body (`resultInfo` and `merchantInformation` optional per API contract)
    """ # noqa: E501
    result_info: Optional[MemberAssetResultInfo] = Field(default=None)
    merchant_information: Optional[MerchantInformation] = Field(default=None)
    __properties: ClassVar[List[str]] = ["resultInfo", "merchantInformation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.merchant_information:
            _dict['merchantInformation'] = self.merchant_information.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryMerchantInfoResponseResponseBody".endswith("Response") and "response" in obj and "body" in obj["response"]:
            ...
            _obj = cls.model_validate({
                ...
                "merchantInformation": MerchantInformation.from_dict(obj["merchantInformation"]) if obj.get("merchantInformation") is not None else None
            })
        else:
