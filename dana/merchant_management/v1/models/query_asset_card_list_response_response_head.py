...
class QueryAssetCardListResponseResponseHead(BaseModel, BaseSdkModel):
    """
    ...
    resp_time: Optional[StrictStr] = Field(default=None, description="DateTime with timezone (ISO-8601)")
    ...
    def function_validate_enum(cls, value):
        ...
        if value not in set(['dana.member.asset.queryAssetCardList']):
            raise ValueError("must be one of enum values ('dana.member.asset.queryAssetCardList')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryAssetCardListResponseResponseHead".endswith("Response") and "response" in obj and "body" in obj["response"]:
