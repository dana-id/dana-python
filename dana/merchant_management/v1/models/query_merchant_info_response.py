...
class QueryMerchantInfoResponse(BaseModel, BaseSdkModel):
    """
    QueryMerchantInfoResponse
    """ # noqa: E501
    response: Optional[QueryMerchantInfoResponseResponse] = None
    signature: Optional[StrictStr] = Field(default=None, description="Signature")
    __properties: ClassVar[List[str]] = ["response", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "QueryMerchantInfoResponse".endswith("Response") and "response" in obj and "body" in obj["response"]:
            # For OPEN_API nested format, pass the nested response structure directly
            _obj = cls.model_validate({
                "response": QueryMerchantInfoResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
