...
class ConsultPayResponse(BaseModel, BaseSdkModel):
    ...
    ConsultPayResponse
    """ # noqa: E501
    response_code: Optional[Annotated[str, Field(strict=True, max_length=7)]] = Field(default=None, alias="responseCode")
    response_message: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="The response code - response message:<br> * 2000000 - Successful<br> * 4000000 - Bad Request - Retry request with proper parameter<br> * 4000001 - Invalid format for certain field - Retry request with proper parameter<br> * 4000002 - Missing or invalid format on mandatory field - Retry request with proper parameter<br> * 4010000 - Signature is invalid - Retry request with proper parameter<br> * 4030005 - Account or user status is abnormal - Retry request with proper parameter or can contact DANA to check the user/account status<br> * 4030015 - Transaction not permitted - Retry request periodically or consult to DANA<br> * 4040008 - Merchant does not exist or status abnormal - Retry request with proper parameter<br> * 4290000 - Maximum transaction limit exceeded - Retry request periodically by sending same request payload<br> * 5000000 - General error - Retry request periodically<br> ", alias="responseMessage")
    payment_infos: Optional[List[PaymentInfo]] = Field(default=None, alias="paymentInfos")
